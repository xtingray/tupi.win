...
INCLUDEPATH += $$TUPI_HOME/src/framework/tcore $$TUPI_HOME/src/framework 

RESOURCES += tgui_images.qrc

linux-g{
    TARGETDEPS += $$TUPI_HOME/src/framework/tcore/libtupifwcore.so
}

LIBS += -L$$BINDIR/src/framework/tcore -ltupifwcore
